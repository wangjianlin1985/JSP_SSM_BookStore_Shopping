...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">网上书店商城</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            ...
            <!-- 
                ...
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=1">计算机类</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=2">历史类</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=3">电子技术类</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=4">文学类</a></li> 
